...
var removeMetricsTests = [
    ...
    {
        input:
            "menu č.4  po vypredaní menu č. 1 a 2 do 13:00 h: 180 g Vyprážaný kurací rezeň s opekanými zemiakmi, tatárska omáčka",
        result:
            "menu č.4  po vypredaní menu č. 1 a 2 do 13:00 h: Vyprážaný kurací rezeň s opekanými zemiakmi, tatárska omáčka"
    }
];
...
var correctCommaSpacingTests = [
    ...
    { input: "Držková polievka,chlieb", result: "Držková polievka, chlieb" },
    {
        input: "menu č.4 po vypredaní menu č. 1 a 2 do 13:00 h",
        result: "menu č. 4 po vypredaní menu č. 1 a 2 do 13:00 h"
    },
    { input: "text without comma", result: "text without comma" }
];

var capitalizeFirstLetter = [{ input: "držková polievka, chlieb", result: "Držková polievka, chlieb" }];
