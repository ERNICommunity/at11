...
const parsePriceTests = [
    {
        input: "Hodnota stravy: 3,50 Eur",
        result: { price: 3.5, text: "Hodnota stravy:" },
    },
    ...
    { input: "text3,50. € text", result: { price: 3.5, text: "text text" } },
    {
        input: "text 3.50     € text",
        result: { price: 3.5, text: "text  text" },
    },
    {
        input: "text 123.45€ text",
        result: { price: 123.45, text: "text  text" },
    },
    { input: "text 5€ text", result: { price: 5, text: "text  text" } },
    { input: "text 5 Eur text", result: { price: 5, text: "text  text" } },
    { input: "text 5. euR text", result: { price: 5, text: "text  text" } },
    {
        input: "text 3.50   eur text",
        result: { price: 3.5, text: "text  text" },
    },
    {
        input: "text 1eur3.50 text",
        result: { price: 1, text: "text 3.50 text" },
    },
];
...
const ocrCleanup = [
    ...
    {
        input: "pri'prava môže trvat' 10 minu't",
        result: "príprava môže trvať 10 minút",
    },
