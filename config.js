module.exports = {
    ...
    restaurants: [
        ...
        {name: "Kamenica - Corleone Pizza", url: "http://restauracie.sme.sk/restauracia/kamenica-corleone-pizza_660-petrzalka_664/denne-menu", module: "sme"},
        {name: "Numero Uno", url: "http://www.obedovat.sk/restauracia/6498-numero-uno/denne-menu", module: "obedovat"}
    ]
};
