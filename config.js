module.exports = {
    ...
    restaurants: [
        ...
        {name: "ITB", url: "http://itbfood.sk/index.php?id=1&type=main_menu&t=1", module: "itb"},
        ...
        {name: "Pizza Pazza", url: "http://www.obedovat.sk/restauracia/8845-pizza-pazza-vienna-gate/denne-menu", module: "obedovat"}
    ]
};
