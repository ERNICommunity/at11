...
global.String.prototype.tidyAfterOCR =
    global.String.prototype.tidyAfterOCR ||
    function() {
...
global.String.prototype.normalizeWhitespace =
    global.String.prototype.normalizeWhitespace ||
    function() {
...
global.String.prototype.correctCommaSpacing =
    global.String.prototype.correctCommaSpacing ||
    function() {
        return this.replace(/(\S) *(,|\.) *(\S)/g, "$1$2 $3");
    };

global.String.prototype.removeMetrics =
    global.String.prototype.removeMetrics ||
    function() {
...
global.String.prototype.capitalizeFirstLetter =
    global.String.prototype.capitalizeFirstLetter ||
    function() {
        return this.replace(/(^[A-Za-z\u00C0-\u017F])/, function(a) {
            return a.toUpperCase();
        });
    };

global.String.prototype.removeItemNumbering =
    global.String.prototype.removeItemNumbering ||
    function() {
